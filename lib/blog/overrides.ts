...
type OverridesMap = Record<string, BlogOverride>

// Professional LinkedIn-style rewrites for enterprise audience
export const overrides: OverridesMap = {
  'chatgpt-5-daily-productivity-tips': {
    featured_image: '/images/blog1.png',
    reading_time: 5,
    excerpt:
      'ChatGPT 5 represents the most significant upgrade to workplace productivity tools since email, offering unprecedented contextual understanding and iterative collaboration capabilities that seamlessly integrate into existing enterprise workflows.',
...
**Competitive Advantage Window**: Organizations that effectively integrate AI-assisted workflows now may gain significant advantages over those that delay adoption.`,
  ...
  'open-source-ai-models-private-companies': {
    ...
    reading_time: 5,
    excerpt:
      'The shift toward open source AI models addresses critical enterprise pain points around data sovereignty, cost predictability, and compliance—enabling organizations to deploy cutting-edge AI capabilities without compromising security or budget control.',
...
**Infrastructure Investment**: Success requires significant upfront investment in technical talent and computing infrastructure, making this approach most suitable for organizations with existing technical capabilities.`,
  ...
  'llm-primer-how-large-language-models-work': {
    ...
    reading_time: 5,
    excerpt:
      'Understanding LLM architecture has become as essential as grasping cloud computing once was. These sophisticated pattern-matching systems are transforming from research curiosities into business-critical infrastructure that requires strategic comprehension.',
...
**Quality Assurance Critical**: LLM outputs require systematic validation processes, especially for mission-critical applications where accuracy and consistency are paramount.`,
  ...
  'getting-started-ai-small-business': {
    ...
    reading_time: 5,
    excerpt:
      'Main street businesses are discovering that successful AI implementation requires strategic thinking over technical sophistication. The key lies in starting with operational pain points rather than chasing technological possibilities.',
...
**Human-AI Collaboration**: The most effective implementations enhance human capabilities rather than replacing them, maintaining the personal touch that often differentiates smaller businesses.`,
  ...
  'chatgpt-privacy-search-results-concerns': {
    ...
    reading_time: 5,
    excerpt:
      'The emergence of AI conversations in search results has created new enterprise risk categories that extend beyond traditional data governance. Organizations need structured frameworks to navigate the nuanced boundaries between private consultation and public disclosure.',
...
export function getOverrideForSlug(slug: string): BlogOverride | undefined {
  return overrides[slug]
}

export function getOverridesMap(): OverridesMap {
  return overrides
}