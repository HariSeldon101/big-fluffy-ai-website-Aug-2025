...
import { Bot, CheckCircle, ArrowRight, Users, Target, TrendingUp } from 'lucide-react'
...
const process = [
  ...
  },
  {
    ...
    description: 'Create a comprehensive AI strategy aligned with your business objectives and growth plans.'
  },
  {
    icon: TrendingUp,
    title: 'Implementation Planning',
    description: 'Develop detailed roadmaps, timelines, and resource requirements for successful AI adoption.'
  }
]
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center mb-6">
              <Bot className="h-12 w-12 text-primary-500 mr-4" />
              <h1 className="text-4xl md:text-6xl font-bold gradient-text">
                AI Consultancy
              </h1>
            </div>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Strategic AI guidance to identify opportunities, assess feasibility, and develop 
              comprehensive implementation roadmaps that align with your business objectives.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Comprehensive AI strategy consulting tailored to your specific business needs and goals.
            </p>
          </motion.div>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-bold text-foreground mb-4">Our Consultancy Process</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A structured approach to understanding your needs and delivering actionable AI strategies.
            </p>
          </motion.div>
